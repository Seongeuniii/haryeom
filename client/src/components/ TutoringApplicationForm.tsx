            ...
            return (
                <ApplyTutoringForm>
                        ...
                        <SelectForm
                            ...
                            handleSelect={(name, clickedOption) => {
                                if (typeof clickedOption === 'string') {
                                    const optionIndex = subjectDefaultOptions.findIndex(option => option.trim() === clickedOption.trim());
                                    if (optionIndex !== -1) {
                    ...
                    <InputTutoringFee>
                        ...
                        label={''}
                        name={'hourlyRate'} 
                        handleChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('hourlyRate', e.target.value)}
                        />
                        <span>원</span>
                    </InputTutoringFee>
