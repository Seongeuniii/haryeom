                    ...
                    <InfoBody>
                        ...
                        <RequiredInfo>
                            ...
                            <ProfileInfo>
                                ...
                                <InfoContent>
                                    <div><input type = "text" name="name" value = {profile.name}/></div>
                                    {isStudent() && <div><input type="text" name = "grade" value = {profile.grade}/> select</div>}
                                    {isStudent() && <div><input type="text" name = "school" value = {profile.school}/></div>}
                                    {isTeacher() && <div>{profile.college}</div>}
                                    <div><input type = "text" name="phone" value={profile.phone}/></div>
                                </InfoContent>
                            </ProfileInfo>
                        </RequiredInfo>
                    </InfoBody>
                    {isTeacher() && <InfoBody>
                        ...
                        <OptionalInfo>
                            ...
                            <TeacherInfo>
                                ...
                                <div><input className="salaryInput" type="number" value = {profile.salary}/>만원</div>
                                <div className="infoName">경력</div>
                                <div><input className="careerInput" type="number" value = {profile.career}/>년</div>
                            </TeacherInfo>
                            <InfoContent>
                                <div className="infoName">가르칠 과목
                                    <button>+</button>
                                    <button>-</button>
                                </div>
                                <div>
