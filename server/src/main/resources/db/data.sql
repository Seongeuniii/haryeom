...
(1, 'TEACHER', NOW(), NOW()),
(2, 'STUDENT', DATEADD('SECOND', 20, CURRENT_TIMESTAMP()), DATEADD('SECOND', 10, CURRENT_TIMESTAMP()));
...
(2, 1, 'Resource 2', 200, DATEADD('SECOND', 20, CURRENT_TIMESTAMP()), DATEADD('SECOND', 10, CURRENT_TIMESTAMP()));
